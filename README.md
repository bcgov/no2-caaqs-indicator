...
# Nitrogen Dioxide CAAQS Analysis for B.C.

A set of R scripts to calculate the Canadian Ambient Air Quality Standards (CAAQS) 
for Nitrogen Dioxide (NO<sub>2</sub>) in British Columbia. 
...
To report bugs/issues/feature requests, please file an [issue](https://github.com/bcgov/no2-caaqs-analysis/issues/).
