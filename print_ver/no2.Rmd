...
output: pdf_document
title: "Status of Nitrogen Dioxide in B.C. (2018-2020)"
---
...
-   **Nitrogen dioxide is an air pollutant.** ~~Solid or liquid
    ...
    nitrogen dioxide (NO~2~). Nitrogen dioxide comes from
...
-   **Nitrogen dioxide can be harmful to humans.** ~~Exposure to
    nitrogen dioxide has been associated with several serious
    health effects including heart and lung disease.^[1](#fn1)^ Both
    short-term (24-hour) and longer-term (a year or more) exposure to
    nitrogen dioxide can have negative effects on human health.~~
...
-   **Nitrogen dioxide levels met both of the Canadian Ambient
    Air Quality Standards in five of B.C.'s seven air zones.** 
    All air zones met the annual standard. 
    Central Interior, Coastal, Georgia Strait, Northeast, and Southern Interior
    air zones met the 1-hr standard, while the Lower Fraser Valley air zone 
    exceeded it. Currently, there are no 
